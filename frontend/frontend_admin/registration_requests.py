    ...
    def build_search_area():
        return ft.Row(
            [
                ...
                ft.Dropdown(label="Sort", width=180, options=[ft.dropdown.Option(option) for option in SORT_OPTIONS], value=active_sort, on_change=lambda e: set_sort_filter(e.control.value)),
