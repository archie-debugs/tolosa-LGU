...
def build_admin_dashboard_view(surface_card, section_header, open_preview_notice):
    stat_cards = [
    ...
    quick_actions = surface_card(
        ft.Column(
            [
                ...
                ft.Row(
                    [
                        ft.ElevatedButton("Review Registrations", icon=ft.icons.CHECKLIST_OUTLINED, on_click=lambda _: open_preview_notice(None)),
